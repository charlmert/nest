...
#
# Usage:		./sqlstreamer label options
...
MYSQL_PROFILE_TYPE="ASCII"
MYSQL_PROFILE_PARAMS=2 # where to look for parameter, will be replaced with get_opt or shifting

PSQL_BIN=`which psql`
PSQL_PROFILE_TYPE="ASCII"
PSQL_PROFILE_PARAMS=2

SQLITE_BIN=`which sqlite`
SQLITE_PROFILE_TYPE="ASCII"
SQLITE_PROFILE_PARAMS=0
...
SHINY_BIN=$MYSQL_BIN
SHINY_OPT=$MYSQL_OPT
SHINY_PROFILE_TYPE=$MYSQL_PROFILE_TYPE
SHINY_PROFILE_PARAMS=$MYSQL_PROFILE_PARAMS
